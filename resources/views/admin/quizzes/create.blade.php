...
<div class="py-12 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm p-6">
            <!-- Header -->
            <h1 class="text-3xl font-extrabold text-gray-900 mb-8">Create New Quiz</h1>
            ...
            <form action="{{ route('admin.quizzes.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="3"
                              class="mt-1 block w-full rounded-md border border-gray-300 py-2 px-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 @error('description') border-red-300 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="mt-1 text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div id="questions-container" class="space-y-6">
                    ...
                    <div class="question p-6 border border-gray-200 rounded-lg bg-gray-50">
                        <div class="mb-4">
                            <label for="questions[0][question_text]" class="block text-sm font-medium text-gray-700">Question Text</label>
                            <input type="text" 
                        ...
                        <div class="options-container space-y-4">
                            ...
                            <div class="option">
                                <label for="questions[0][options][0][option_text]" class="block text-sm font-medium text-gray-700">Option Text</label>
                                <input type="text" 
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        let questionIndex = 1;
        let optionIndices = { 0: 1 }; // Track option index per question
